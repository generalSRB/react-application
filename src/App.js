...
class App extends Component {
    ...
    setData = () => {
      ...
      fetch("https://react-app-project-9a165.firebaseio.com/people.json")
      .then(response => {
  ...
  onCardRemove = (id) => {
    fetch(`https://react-app-project-9a165.firebaseio.com/people/${id}.json`, {
      method: "DELETE"
    })
    .then(response => {
      this.setData();
  ...
  render () {
    ...
    const {data, formOpened} = this.state;
    return (
      <Fragment>
        <Header 
